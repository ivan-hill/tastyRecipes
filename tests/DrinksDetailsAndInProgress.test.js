...
describe('Implement the screen  Drink Recipe Details e In Progress', () => {
  test('1- verifica o caminho para pagina de detalhes', async () => {
    ...
    const GGIngredient1 = await screen.findByRole('checkbox', {
    ...
    const GGIngredient2 = await screen.findByRole('checkbox', {
      name: /ginger ale - undefined/i,
    });
    ...
    const GGIngredient3 = screen.getByRole('checkbox', {
      name: /ice - undefined/i,
    });
